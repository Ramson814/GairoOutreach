...
public class GairoHighlights extends JFrame implements ActionListener {
...
//        sideMenuLayout.createSequentialGroup();
        ...
        try {
            File file = new File("C:\\Users\\RAMSON\\Documents\\NetBeansProjects\\GairoOutreach\\src\\injili\\waombewa.jpg");
            ImageIO.read(file);
        ...
        try {
            File file = new File("C:\\Users\\RAMSON\\Documents\\NetBeansProjects\\GairoOutreach\\src\\injili\\door.jpg");
            ImageIO.read(file);
        ...
        try {
            File file = new File("C:\\Users\\RAMSON\\Documents\\NetBeansProjects\\GairoOutreach\\src\\injili\\watoto.jpg");
            ImageIO.read(file);
        ...
        try {
            File file = new File("C:\\Users\\RAMSON\\Documents\\NetBeansProjects\\GairoOutreach\\src\\injili\\wapishi.jpg");
            ImageIO.read(file);
        ...
        try {
            File file = new File("C:\\Users\\RAMSON\\Documents\\NetBeansProjects\\GairoOutreach\\src\\injili\\sifa.jpg");
            ImageIO.read(file);
        ...
        try {
            File file = new File("C:\\Users\\RAMSON\\Documents\\NetBeansProjects\\GairoOutreach\\src\\injili\\crowd.jpg");
            ImageIO.read(file);
        ...
        //////////////////////
        ujumbe = new JLabel("Akawaambia,Enendeni ulimwenguni mwote,mkaihubiri Injili kwa kila kiumbe.");
        ujumbe.setBounds(290, 590, 750, 30);
        ujumbe.setForeground(new Color(255, 255, 255));
        ujumbe.setFont(new Font("Railway", Font.BOLD, 20));
        add(ujumbe);

        eujumbe = new JLabel("And He said to them, “Go into all the world and preach the gospel to every creature.");
        ...
        /////////////////////////
        ujumbe1 = new JLabel("Ushuhudiaji wa nyumba kwa nyumba");
        ujumbe1.setBounds(290, 590, 750, 30);
        ujumbe1.setForeground(new Color(255, 255, 255));
        ujumbe1.setFont(new Font("Railway", Font.BOLD, 20));
        ujumbe1.setVisible(false);
        add(ujumbe1);

        eujumbe1 = new JLabel("Door to door Gospeling(house-to-house witnessing)");
        eujumbe1.setBounds(290, 620, 750, 30);
        ...
        ////////////////////
        ujumbe2 = new JLabel("Watu wakiombewa mkutanoni");
        ujumbe2.setBounds(290, 590, 700, 30);
        ujumbe2.setForeground(new Color(255, 255, 255));
        ujumbe2.setFont(new Font("Railway", Font.BOLD, 20));
        ujumbe2.setVisible(false);
        add(ujumbe2);

        eujumbe2 = new JLabel("People being Prayed for in the gospel meeting ");
        eujumbe2.setBounds(290, 620, 700, 30);
        ...
        ///////////////////
        ujumbe3 = new JLabel("Watoto wakiombewa");
        ...
        eujumbe3 = new JLabel("Children being prayed for in the gospel meeting");
        ...
        ////////////////////
        ujumbe4 = new JLabel("Wapishi wakigawa chakula");
        ujumbe4.setBounds(290, 590, 400, 30);
        ujumbe4.setForeground(new Color(255, 255, 255));
        ujumbe4.setVisible(false);
        ujumbe4.setFont(new Font("Railway", Font.BOLD, 20));
        add(ujumbe4);

        eujumbe4 = new JLabel("Cooks serving for food");
        eujumbe4.setBounds(290, 620, 400, 30);
        ...
        ////////////////////////
        ujumbe5 = new JLabel("Watu wakisifu");
        ujumbe5.setBounds(290, 590, 400, 30);
        ujumbe5.setForeground(new Color(255, 255, 255));
        ujumbe5.setVisible(false);
        ujumbe5.setFont(new Font("Railway", Font.BOLD, 20));
        add(ujumbe5);

        eujumbe5 = new JLabel("People praising before the lord");
        eujumbe5.setBounds(290, 620, 400, 30);
        ...
        ////////////////////////
        ujumbe6 = new JLabel("Watu 1695 wampa yesu maisha(Waokoka)");
        ujumbe6.setBounds(290, 590, 400, 30);
        ujumbe6.setForeground(new Color(255, 255, 255));
        ujumbe6.setVisible(false);
        ujumbe6.setFont(new Font("Railway", Font.BOLD, 20));
        add(ujumbe6);

        eujumbe6 = new JLabel("1695 People give life to Jesus(Are saved)");
        eujumbe6.setBounds(290, 620, 400, 30);
